...
**반드시 {country_info['name']}의 교육 문화 맥락에서 설명해야 합니다:**
- 이 행사가 {country_info['name']}에서 어떤 의미와 중요성을 가지는지
- {country_info['name']}의 교육 시스템에서 이 행사가 어떻게 진행되는지
- 한인 학부모가 알아야 할 {country_info['name']}의 문화적 배경 (2-3문장)

💡 **실용적인 팁**:
**{country_info['name']}에서 실제로 유용한 정보를 제공해야 합니다:**
- {country_info['name']}의 관습에 맞는 준비 방법
- 한인 학부모가 주의해야 할 사항
- {country_info['name']}에서 흔히 하는 실수나 놓치기 쉬운 점 (2-3문장)
